...
const ContactPage = () => (
  <section className="py-20 text-center">
    ...
    <form method="post" className="w-2/3 m-auto w-full max-w-sm px-8 py-6">
      <div className="mb-6">
        <label className="block text-gray-700 text-lg mb-2 text-left ">
          Name
        </label>
      ...
      <div className="mb-6">
        ...
        <textarea className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline max-h-screen"  name="message"></textarea>
      </div>
