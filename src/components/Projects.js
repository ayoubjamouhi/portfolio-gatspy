...
const Projects = () => (
  <section className="projects text-center p-16">
    ...
    <div class="projects__all grid md:grid-cols-2 lg:grid-cols-3 text-center gap-16">
        ...
        <div>
          <a href="http://compulog.ma">
            <img alt="AYOUB JAMOYHI projects" className="w-4/5 m-auto rounded" src={subCom} />
          </a>
        </div>
        <div>
          <a href="http://compulog.ma">
            <img alt="AYOUB JAMOYHI projects" className="w-4/5 m-auto rounded" src={gestion_comp} />
          </a>
        </div>
    </div>
    </section>
